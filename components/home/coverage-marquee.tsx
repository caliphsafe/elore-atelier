...
const coverageLogos = [
  {
    src: "/images/home/coverage/boston.png",
    alt: "Boston media coverage"
  },
  {
    src: "/images/home/coverage/downtown.png",
    alt: "Downtown media coverage"
  },
  {
    src: "/images/home/coverage/globe.png",
    alt: "Globe media coverage"
  },
  {
    src: "/images/home/coverage/huston.png",
    alt: "Huston media coverage"
  }
];
    ...
    <section className="px-5 pb-16 pt-2 md:px-8 md:pb-20 lg:px-12">
      <style>{`
        ...
        .coverage-marquee {
          ...
          gap: 3rem;
          align-items: center;
          animation: coverageMarquee 34s linear infinite;
        }
      ...
      <div className="editorial-container">
        <div className="overflow-hidden rounded-luxe border thin-border bg-white/82 py-6 shadow-soft backdrop-blur">
          <h2 className="serif-display px-6 text-3xl leading-tight text-brand-ink md:px-8 md:text-4xl">
            Covered By
          </h2>
            ...
            <div className="coverage-marquee" aria-label="ELÖRE Atelier media coverage logos">
              {marqueeLogos.map((logo, index) => (
                <div className="coverage-logo" key={`${logo.src}-${index}`}>
                  <Image
                    src={logo.src}
                    alt={index < coverageLogos.length ? logo.alt : ""}
                    fill
                    sizes="180px"
